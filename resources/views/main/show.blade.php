    ...
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <header class="flex justify-between items-center space-x-5 text-slate-900">
            ...
            <form action="{{ route('index') }}" class="pb-3 pr-2 flex items-center border-b border-b-slate-300 text-slate-300 focus-within:border-b-slate-900 focus-within:text-slate-900 transition">
                <input id="search" value="" class="px-2 w-full outline-none leading-none placeholder-slate-400" type="search" name="search" placeholder="Find a blog post">
                <button>
            ...
            <div class="space-y-10 md:space-y-16">
                ...
                <article class="flex flex-col lg:flex-row pb-10 md:pb-16 border-b">
                    ...
                    <div class="flex flex-col items-start mt-5 space-y-5 lg:w-7/12 lg:mt-0 lg:ml-12">
                        <a href="" class="underline font-bold text-slate-900 text-lg">Category</a>
